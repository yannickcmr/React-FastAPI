...
class OnlineFacility(BaseModel):
    ...
    parameter: dict = Field(default={'probability': 1.0, 'costs': 1, 'metric': 'euclidean'}, description="Config for the Facility Location Problem.")
...
class OfflineFacility(BaseModel):
    ...
    parameter: dict = Field(default={'iterations': 10.0, 'costs': 1, 'metric': 'euclidean'}, description="Config for the Facility Location Problem.")
